    ...
    <>
      ...
      <div id="admin-page-main-home">
        ...
        <div id="main-container-of-the-addmin-page">
          <div id="add-car">
            <h3 id="info">Cars</h3>
            <Link to="/add-car-details" id="btn-add-car-link">
          ...
          {loading ? (
            ...
            <>
              {err && (
                <div id="display-message-on-the-admin-pag-for-the-err">
                  {err}{' '}
                  <span
                    onClick={() => {
                      setErr("");
                    ...
                    id="button-ok-for-th-delee-things"
                  >
                    {ok}
                  </span>
                </div>
                ...
                {car.map((d, i) => (
                  <div key={i} id="car-container">
                    ...
                    <div id="date-container-of-the-file-data-date">
                      <span id="available-date-of-sata-of-the-page">
                        Available Date
                      </span>
                      <span
                        id="date-avalable-from-till-data-of-the-admin-page"
                      >
                        {`${d.avalableFrom
                          .split("-")
                          .reverse()
                          .join("/")
                          .slice(0, 5)}-${d.availableTill
                          .split("-")
                          .reverse()
                          .join("/")
                          .slice(0, 5)}`}
